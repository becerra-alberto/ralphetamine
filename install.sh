...
echo ""
echo "  Pipelines (recommended):"
echo "    /ralph-pipeline-full-auto    # Fully autonomous: idea -> committed code"
echo "    /ralph-pipeline-interactive  # Guided pipeline with review checkpoints"
echo ""
echo "  Individual steps:"
echo "    /prd                         # Create a PRD"
echo "    /ralph                       # Convert PRD to specs + story queue"
echo "    /ralph-create-spec           # Add a single ad-hoc story spec"
echo ""
echo "  CLI:"
echo "    ralph init                   # Initialize Ralph in a project"
echo "    ralph run                    # Run the autonomous loop"
echo "    ralph status                 # Check progress"
echo ""
echo "  Post-run:"
echo "    /ralph-reconcile-claude-code # Reconcile orphaned branches"
echo "    /ralph-reconcile-codex       # Reconcile (Codex mode)"
echo ""
