...
*Auto-generated by Claude skill: ChangeLog*
...
- **Pipeline worktree isolation** — interactive and full-auto pipelines now execute in git worktrees for safe parallel operation (Pipeline)
- **BMAD Review Party gates** — interactive pipeline gains structured review checkpoints inspired by the BMAD methodology (Pipeline)
- **Parallel batch fix** — batch loop no longer exits early when batch numbers don't start at 0; decimal batch numbers now supported (Parallel)

*Date ascending, then area alphabetically*

| # | Date | Type | Area | Change | Commit |
|---|------|------|------|--------|--------|
| 1 | 2026-02-13 | Changed | Docs | Open-source readiness: README rewrite, 10-phase audit fixes, license and governance prep | 2b72e0c, 16d10ea, 481c69a |
| 2 | 2026-02-13 | Changed | Docs | Update all documentation references to v2.4.0 | 1e29311 |
| 3 | 2026-02-14 | Added | Pipeline | Worktree isolation for interactive pipeline — specs generate in isolated branches | 1be6f50 |
| 4 | 2026-02-16 | Changed | Docs | Add two-remote workflow documentation (private dev + public release) | 3368266 |
| 5 | 2026-02-16 | Fixed | Parallel | Batch loop exits immediately when batch numbers don't start at 0; add decimal batch support | e7df742 |
| 6 | 2026-02-16 | Added | Pipeline | BMAD-inspired Review Party gates for interactive pipeline | 24fed91 |
| 7 | 2026-02-16 | Fixed | Pipeline | Correct phase range and error recovery numbering in interactive pipeline | 2bf2231 |
| 8 | 2026-02-16 | Added | Pipeline | Worktree isolation for full-auto pipeline | 5864555 |
