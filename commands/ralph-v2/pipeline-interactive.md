...
**This orchestrates the entire Ralph v2 workflow interactively.** It chains PRD creation, spec generation, premortem review, and run script generation into a single guided session. For the fully autonomous version, use `/ralph-v2:pipeline-full-auto`.
